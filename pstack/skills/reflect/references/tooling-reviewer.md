...
- `Read` tool calls against any `SKILL.md` file (the project-local Pi skill directory, the user-level Pi skill directory, or another installed Pi skill path)
- delegated prompts that name a skill path
