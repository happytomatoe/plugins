...
Before spawning investigators, list the available MCPs from the Pi environment. Use the available-tools map when present. Otherwise record that MCP discovery is unavailable.
