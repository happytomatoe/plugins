...
Run a single delegated Pi pass that explores and explains in one pass:
...
Once all explorers return, run a single delegated Pi pass to synthesize their findings into one coherent explanation:
